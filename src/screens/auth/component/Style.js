...
authContainer:{backgroundColor:'white',borderRadius:20,width: width >= TABLET_WIDTH ? responsiveWidth(73.26) : responsiveWidth(65),height: width >= TABLET_WIDTH ? responsiveHeight(49) : responsiveHeight(89),marginTop: width >= TABLET_WIDTH ? 130 : responsiveHeight(4),alignSelf:'center', borderColor:'#E88102',borderWidth:1,position:'absolute'},
