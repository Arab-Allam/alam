...
const QuestionPageStyle = StyleSheet.create({
    ...
    nameText: {fontSize: width >= TABLET_WIDTH ? responsiveFontSize(1.4) : responsiveFontSize(1.8),fontWeight:'bold',textAlign: 'center',fontFamily:Font.bold},
    pointsText: {fontSize: width >= TABLET_WIDTH ?  responsiveFontSize(1): responsiveFontSize(1.4) ,textAlign: 'center',color:"#000", fontFamily:Font.bold},
    ...
    Coine:{width: width >= TABLET_WIDTH ? responsiveWidth(4): responsiveWidth(2.5), height:width >= TABLET_WIDTH ? responsiveHeight(5.5) : responsiveHeight(5.4),position:'absolute',right: width >= TABLET_WIDTH ? responsiveWidth(24) : responsiveWidth(19.5) ,bottom: width >= TABLET_WIDTH ? responsiveHeight(0.4) : responsiveHeight(1.5) }
}
)
